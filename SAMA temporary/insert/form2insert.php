    ...
    if(isset($postdata))
    {
         ...
         @$form1detail_date !== "")
        {
            ...
            else
            {
                ...
                $sql = "INSERT INTO std_activity ( std_firstname, std_lastname, std_classroom, std_number, std_dormitory,
                  std_ID, act_date, act_hours, act_places, act_details, act_feels, act_type, act_type_name, phone_id)
