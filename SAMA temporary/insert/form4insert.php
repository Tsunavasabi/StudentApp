            ...
            else
            {
              ...
              @$form1detail_act_name = $request->act_type_name;
                ...
                $sql = "INSERT INTO std_activity ( std_firstname, std_lastname, std_classroom,
                  std_number, std_dormitory, std_ID, act_head, act_places,
                  act_details, act_feels, act_type, act_type_name, phone_id)
                VALUES ('$form1detail_firstname','$form1detail_lastname', '$form1detail_classroom',
                        ...
                        '$form1detail_place', '$form1detail_make', '$form1detail_feel',
                        '$form1detail_type', '$form1detail_act_name', '$form1detail_pnid')";
