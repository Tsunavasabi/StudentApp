<?php
    ...
    if(isset($postdata))
    {
        ...
        @$form1detail_print = $request->print;
        @$form1detail_hour = $request->hour;
        @$form1detail_place = $request->place;
         ...
         @$form1detail_date !== "")
        {
            ...
            else
            {
                ...
                $sql = "INSERT INTO std_activity ( std_firstname, std_lastname, std_classroom,
                  std_number, std_dormitory, std_ID, act_head, act_print, act_date,
                  act_hours, act_places, act_details, act_feels, act_type, act_type_name, phone_id)
                VALUES ('$form1detail_firstname','$form1detail_lastname', '$form1detail_classroom',
                        '$form1detail_number', '$form1detail_dorm', '$form1detail_ID', '$form1detail_head', '$form1detail_print',
                        '$form1detail_date', '$form1detail_hour', '$form1detail_place',
                        '$form1detail_make', '$form1detail_feel','$form1detail_type',
