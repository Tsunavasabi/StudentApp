...
@IonicPage()
@Component({
  selector: 'page-personlecture',
  templateUrl: 'personlecture.html',
})
export class PersonlecturePage {
  public outreach: any;
  public act_id: {};
  public send: boolean;
  public flag: any;
  ...
  deletedata(act_id) {
    console.log(act_id);
    this.deleteService.deletepersonlecture(act_id)
    .then(data => {
  ...
  doRefresh(refresher) {
    this.selectService.Selectpersonlecture()
    .then(data => {
      console.log(data);
      this.outreach = data;
    });
