...
@IonicPage()
@Component({
  selector: 'page-buddhacamp',
  templateUrl: 'buddhacamp.html',
})
export class BuddhacampPage {
  public outreach: any;
  public act_id: {};
  public send: boolean;
  public flag: any;
  ...
  updatedata(act_id) {
    console.log(act_id);
    this.updateService.updatebuddha(act_id)
    .then(data => {
  ...
  deletedata(act_id) {
    console.log(act_id);
    this.deleteService.deletebuddha(act_id)
    .then(data => {
