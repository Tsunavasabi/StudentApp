...
@IonicPage()
@Component({
  selector: 'page-scilecture',
  templateUrl: 'scilecture.html',
})
export class ScilecturePage {
  public outreach: any;
  public act_id: {};
  public send: boolean;
  public flag: any;
  constructor(public navCtrl: NavController,
    ...
    public alertCtrl: AlertController) {
      this.selectService.Selectscilecture()
      .then(data => {
        this.outreach = data;
      });
  ...
  updatedata(act_id) {
    this.updateService.updatescilecture(act_id)
    .then(data => {
  ...
  deletedata(act_id) {
    console.log(act_id);
    this.deleteService.deletescilecture(act_id)
    .then(data => {
