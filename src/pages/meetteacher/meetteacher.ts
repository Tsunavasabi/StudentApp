...
@IonicPage()
@Component({
  selector: 'page-meetteacher',
  templateUrl: 'meetteacher.html',
})
export class MeetteacherPage {
  public outreach: any;
  public act_id: {};
  public send: boolean;
  public flag: any;
  constructor(public navCtrl: NavController,
    ...
    public alertCtrl: AlertController) {
      this.selectService.Selectmeetteacher()
      .then(data => {
        this.outreach = data;
      });
  ...
  updatedata(act_id) {
    this.updateService.updatemeetteacher(act_id)
    .then(data => {
  ...
  deletedata(act_id) {
    console.log(act_id);
    this.deleteService.deletemeetteacher(act_id)
    .then(data => {
